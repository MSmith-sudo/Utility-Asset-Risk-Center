...
- Synthetic water infrastructure dataset generation
- Random Forest failure risk classification
- Low, Moderate, and High risk categories
- Interactive Streamlit dashboard
- Explainable AI prediction panel
- Historical comparison against dataset averages
